...
import {ExportCurve, Trash} from 'iconsax-react';
...
function UploadAvatar({path, name, onSetFile, resetPath}: PropsUploadAvatar) {
	...
	return (
		<div className={styles.container}>
			<Image alt='update avatar' src={!!imageBase64 ? imageBase64 : path} width={104} height={104} className={styles.avatar} />
				...
				<div className={styles.control}>
					<label className={styles.box_input}>
						...
						<div className={styles.file}>
							{/* <Image alt='Icon import' src={icons.exportFile} width={20} height={20} style={{color: '#000C7C'}} /> */}
							<ExportCurve />
							<p>Chọn file</p>
						</div>
					...
					<div className={styles.btn} onClick={handleRemoveImg}>
						<Trash size='20' color='#AF0000' />
						<p>Gỡ ảnh đại diện</p>
					</div>
				</div>
				<div>Hình ảnh được dùng làm ảnh đại diện, kích thước tối thiểu 300px X 300px.</div>
