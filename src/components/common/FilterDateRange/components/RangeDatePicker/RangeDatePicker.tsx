		...
		>
			<div className={styles.container}>
				...
				<div className={styles.groupBtn}>
					<Button p_8_24 grey bold rounded_50 onClick={onClose}>
						Hủy bỏ
					</Button>
					<Button p_8_24 midnightBlue bold rounded_50 onClick={handleSubmit} disable={!datePicker.from || !datePicker.to}>
						Áp dụng
					</Button>
				</div>
			</div>
